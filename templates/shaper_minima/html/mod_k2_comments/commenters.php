...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2TopCommentersBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	<?php if(count($commenters)): ?>
		...
		<div class="media <?php echo ($key%2) ? "odd" : "even"; if(count($commenters)==$key+1) echo ' lastItem'; ?>">

			<?php if($commenter->userImage): ?>
			<div class="pull-left">
				<a rel="author" href="<?php echo $commenter->link; ?>">
			...
			<div class="media-body">
				...
				<strong class="tcUsername"><?php echo $commenter->userName; ?></strong>
				...
				<small class="tcLatestCommentDate muted"><?php echo JText::_('K2_POSTED_ON'); ?> <?php echo JHTML::_('date', $commenter->latestCommentDate, JText::_('K2_DATE_FORMAT_LC2')); ?></small>
				<div class="clr"></div>
